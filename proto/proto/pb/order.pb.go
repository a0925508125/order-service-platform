...
const file_order_proto_rawDesc = "" +
	"\n" +
	"\vorder.proto\x12\x06common\"^\n" +
	"\fOrderRequest\x12\x17\n" +
	"\auser_id\x18\x01 \x01(\x03R\x06userId\x12\x19\n" +
	"\bevent_id\x18\x02 \x01(\x03R\aeventId\x12\x1a\n" +
	"\bquantity\x18\x03 \x01(\x05R\bquantity\"\x0f\n" +
	"\rOrderResponse2D\n" +
	"\fOrderService\x124\n" +
	"\x05Order\x12\x14.common.OrderRequest\x1a\x15.common.OrderResponseB\rZ\vproto/pb;pbb\x06proto3"
...
var file_order_proto_goTypes = []any{
	(*OrderRequest)(nil),  // 0: common.OrderRequest
	(*OrderResponse)(nil), // 1: common.OrderResponse
}
var file_order_proto_depIdxs = []int32{
	0, // 0: common.OrderService.Order:input_type -> common.OrderRequest
	1, // 1: common.OrderService.Order:output_type -> common.OrderResponse
